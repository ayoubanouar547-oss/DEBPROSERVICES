  ...
  return (
    <>
      <PageHero 
        ...
        description="Conformément au Règlement Général sur la Protection des Données (RGPD) et à la loi belge, nous protégeons vos données."
        primaryButtonText=""
        secondaryButtonText=""
      />
      <div className="pb-24 relative z-10 text-slate-300">
        <div className="max-w-4xl mx-auto px-4 prose prose-lg prose-invert">
          <p className="text-slate-400">Dernière mise à jour : 12 avril 2024</p>
