...
export const metadata: Metadata = {
  title: "Plomberie, Chauffage, Électricité Belgique — PRO SERVICES 24/7",
  description:
    "PRO SERVICES Belgique : plomberie, débouchage, chauffage, électricité et climatisation en urgence. Techniciens qualifiés à votre disposition 24h/24 et 7j/7.",
  keywords:
