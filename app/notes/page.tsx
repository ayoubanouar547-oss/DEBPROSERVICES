    ...
    <main className="min-h-screen pt-32 pb-16 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <p className="text-slate-500 mb-8">
          Consultez les notes techniques et archives de nos interventions.
        </p>
        ...
        {error ? (
          <div className="bg-red-50 text-red-700 p-6 rounded-2xl border border-red-100 shadow-sm">
            ...
            <p className="mb-4 text-slate-600 italic">
              Désolé, nous n'avons pas pu récupérer vos notes. Veuillez
              réessayer plus tard ou contacter le support technique si le
              problème persiste.
            </p>
            ...
            {notes && notes.length > 0 ? (
              <ul className="space-y-6">
                {notes.map((note: any) => (
                  <li
                    key={note.id}
                    className="p-6 border border-slate-100 rounded-2xl bg-slate-50/50 hover:bg-slate-50 transition-colors group"
                  >
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                          Référence: {note.id.substring(0, 8)}
                        </span>
                      </div>
                    </div>
                  </li>
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mb-4">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-file-x text-slate-300"
                  >
                ...
                <p className="text-slate-500 font-medium whitespace-nowrap">
                  Aucune note n'a encore été publiée sur cet interface.
                </p>
              </div>
            )}
          </div>
