...
export const metadata: Metadata = {
  ...
  description: "Fuite d'eau invisible à Bruxelles ? Deb Pro Services intervient pour la détection non destructive. Murs humides, compteur qui tourne. 0498 35 25 88.",
  alternates: {
