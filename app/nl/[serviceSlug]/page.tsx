...
export async function generateMetadata({
  ...
  let description = `${service.title} in België: erkende technici voor alle dringende interventies. 24h/24 & 7j/7 bereikbaar. Direct gratis offerte via ☎ 0492 47 92 01.`;

  if (service.slug === "loodgieter") {
    description =
      "Loodgieter in België spoed 24/7: erkende technici voor lekken, installaties en snelle herstellingen. Gratis offerte. Bel direct ☎ 0492 47 92 01!";
  } else if (service.slug === "ontstopping") {
    description =
      "Ontstopping van leidingen in België 24/7: expert voor verstopte WC, riolen en gootstenen. Gratis offerte, snelle actie en garantie. Bel ☎ 0492 47 92 01!";
  } else if (service.slug === "verwarming") {
    description =
      "Gecertificeerde verwarmingsinstallateur in België: spoedherstelling verwarmingsketel 24/7. Onderhoud en installatie. Gratis offerte ☎ 0492 47 92 01.";
  } else if (service.slug === "gas") {
    description =
      "Gecertificeerde CERGA technici voor alle gasinterventies in België. Lekdetectie, conformiteit, aansluiting. Spoed 24/7 ☎ 0492 47 92 01.";
  } else if (service.slug === "elektriciteit") {
    description =
      "Elektricien in België spoed 24/7: AREI-keuring, zekeringkast vervangen en installatie. Erkende expert, gratis offerte. Bel ☎ 0492 47 92 01.";
  } else if (service.slug === "zonnepanelen") {
    description =
      "Installatie van fotovoltaïsche zonnepanelen en thuisbatterijen in België. Gecertificeerde installateurs, gratis rendementsstudie. Bel ☎ 0492 47 92 01.";
  } else if (service.slug === "dakwerken") {
    description =
      "Dakwerken in België: dringende herstelling van daklekken, renovatie en isolatie. Erkende dakdekkers, gratis offerte. Bel ☎ 0492 47 92 01.";
  } else if (service.slug === "camerabewaking") {
    description =
      "Installatie van camerabewaking en alarmen in België. HD IP-beveiligingssystemen verbonden met uw smartphone. Gratis offerte ☎ 0492 47 92 01.";
  } else if (service.slug === "bouwwerken") {
    description =
      "Aannemer voor ruwbouw- en metselwerken in België. Dragende muren openbreken, IPN-balken, betonplaten. Tienjarige garantie, gratis offerte ☎ 0492 47 92 01.";
  } else if (service.slug === "ruitenwasser") {
    description =
      "Professionele ruitenwasser in België. Wassen van ramen, veranda's, winkeletalages voor particulieren en bedrijven. Streeploos resultaat ☎ 0492 47 92 01.";
  } else if (service.slug === "tuinieren") {
    description =
      "Professionele tuinman in België: tuinonderhoud, snoeien, gevaarlijke bomen vellen en hagen knippen. Gratis offerte ☎ 0492 47 92 01.";
  }
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-white">
              ...
              <div className="mt-10">
                ...
                >
                  <PhoneCall className="w-6 h-6" /> BEL UW EXPERT: 0492 47 92 01
                </a>
              </div>
            </div>
          </div>
