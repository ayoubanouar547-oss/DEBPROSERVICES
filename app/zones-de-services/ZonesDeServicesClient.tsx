        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-black mb-4 md:mb-6 tracking-tight">
                Zones d'Intervention <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">
                  sur toute la Belgique
                </span>
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-2xl leading-relaxed mx-auto lg:mx-0">
                Nos équipes d'urgence sont déployées stratégiquement pour
                garantir une intervention en moins de 30 minutes, 24h/24 et
                7j/7.
              </p>
            </div>
                        ...
                        <div className="flex items-center gap-6">
                          ...
                          <div>
                            ...
                            <p className="text-slate-400 max-w-xl">
                              Intervention express 24h/24 pour tous vos besoins
                              en {service.title.toLowerCase()}.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                searchResults.length > 0 ? (
                  ...
                  <div className="text-center py-40">
                    ...
                    <p className="text-slate-500">
                      Nous n'avons pas trouvé de service ou de ville
