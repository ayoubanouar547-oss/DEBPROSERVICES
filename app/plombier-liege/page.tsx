...
export const metadata: Metadata = {
  ...
  description: "Besoin d'un plombier à Liège ? Deb Pro Service intervient en 30 minutes pour vos fuites, débouchages et installations. Artisans locaux, prix transparents. Appelez le 0496 32 57 33.",
  alternates: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <PhoneCall className="w-5 h-5" /> Urgence Liège : 0496 32 57 33
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-slate-900 rounded-3xl p-10 text-white">
              ...
              <div className="bg-white/10 p-6 rounded-2xl border border-white/10">
                ...
                <a href="tel:0496325733" className="w-full bg-white text-slate-900 font-black py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-slate-100 transition">
                  <PhoneCall className="w-4 h-4" /> 0496 32 57 33
                </a>
              </div>
            </div>
          </div>
