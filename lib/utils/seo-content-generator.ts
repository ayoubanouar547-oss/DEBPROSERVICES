diff --git a/app/[serviceSlug]/page.tsx b/app/[serviceSlug]/page.tsx
index 6ffd01a..c014325 100644
--- a/app/[serviceSlug]/page.tsx
+++ b/app/[serviceSlug]/page.tsx
...
@@ -332,14 +332,14 @@ export default async function ServicePage({
...
+                    title: "Techniciens Agréés & Certifiés",
+                    desc: "Tous nos professionnels sont certifiés, assurés et formés aux dernières normes belges en vigueur.",
                   },
                   {
...
diff --git a/app/zones-de-services/[serviceSlug]/[...cityPath]/page.tsx b/app/zones-de-services/[serviceSlug]/[...cityPath]/page.tsx
index fea94a6..28abd13 100644
--- a/app/zones-de-services/[serviceSlug]/[...cityPath]/page.tsx
+++ b/app/zones-de-services/[serviceSlug]/[...cityPath]/page.tsx
@@ -266,6 +266,7 @@ export default async function UnifiedZonePage({
...
+    serviceInfo.slug,
   ...
   return (
diff --git a/lib/data/services.ts b/lib/data/services.ts
index 4068cd7..32fb6d8 100644
--- a/lib/data/services.ts
+++ b/lib/data/services.ts
@@ -6,6 +6,7 @@ export const services = [
     slug: "renovation-maison",
     title: "Rénovation",
     icon: Home,
+    subTagline: "Tous Corps de Métier · Devis 48h · Garantie Décennale",
     imageUrl:
       "https://debouchageexpress24hh.odoo.com/web/image/4148-835ccca6/regenerated_image_1777316391207.jpg?height=600",
     description:
diff --git a/lib/utils/seo-content-generator.ts b/lib/utils/seo-content-generator.ts
index 8af4347..e8607a0 100644
--- a/lib/utils/seo-content-generator.ts
+++ b/lib/utils/seo-content-generator.ts
@@ -1,45 +1,108 @@
