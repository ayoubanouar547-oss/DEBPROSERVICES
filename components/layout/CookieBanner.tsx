        ...
        >
          <div className="max-w-xl mx-auto bg-slate-900 text-white rounded-3xl shadow-2xl p-8 border border-white/10 flex flex-col items-center text-center gap-6">
            <div className="flex-1">
              ...
              <h3 className="font-heading font-black text-2xl mb-3 text-white">
                Cookies & Confidentialité
              </h3>
              <p className="text-slate-300 text-sm leading-relaxed">
                Nous utilisons des cookies pour améliorer votre expérience de
                navigation, analyser le trafic de notre site et garantir le bon
                fonctionnement des formulaires. En continuant votre navigation,
                vous acceptez notre{" "}
                <Link
                  href="/privacy-policy"
