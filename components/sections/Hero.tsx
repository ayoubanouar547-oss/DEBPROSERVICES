...
export function Hero() {
  ...
  const [displayedText, setDisplayedText] = useState(
    SERVICES[0].text.toUpperCase() + " EN BELGIQUE",
  );
      ...
      <div className="col-span-1 lg:col-span-7 flex flex-col justify-center">
        ...
        <div className="space-y-4">
          <h1 className="font-black leading-tight mb-8">
            <div className="text-[15vw] sm:text-4xl md:text-5xl lg:text-7xl min-h-[220px] sm:min-h-[140px] flex flex-col justify-center">
              ...
              >
                <div
                  className={`bg-clip-text text-transparent bg-gradient-to-r ${SERVICES[serviceIndex].gradient} block sm:inline leading-[0.9]`}
                >
                  {displayedText.substring(
                    0,
                    SERVICES[serviceIndex].text.length,
                  )}
                </div>
          ...
          <p className="text-lg text-slate-100 mb-8 max-w-lg leading-relaxed font-medium">
            Débouchage, chauffage, gaz, électricité et fosse septique.
            Techniciens agréés, disponibles 7j/7 dans toute la Belgique.
          </p>
        </div>
        ...
        <div className="mt-16 flex flex-wrap gap-10">
          <div className="flex flex-col justify-center">
            <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500">
              5000+
            </div>
            <div className="text-[10px] text-blue-200 uppercase tracking-widest font-black mt-2 bg-blue-500/10 px-2 py-0.5 rounded border border-blue-500/20">
              Clients Satisfaits
            </div>
          </div>
